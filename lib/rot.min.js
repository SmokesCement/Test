...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="4D430502:09B1:25F334AA:5646083D" name="octolytics-dimension-request_id" />
...
<meta content="Rails, view, blob#show" data-pjax-transient="true" name="analytics-event" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta content="258f100cf06bd0151d52bc4bb872539cda9eef65" name="form-nonce" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fondras%2Frot.js%2Fblob%2Fmaster%2Frot.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="clone-options text-small text-muted">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="258f100cf06bd0151d52bc4bb872539cda9eef65" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="p2KBlj0g7QSVFxwGdwQf9uuIfEV6Vi18e8FaHPyGOYziEluBelsmEYHeCCqZKTjDe68DJ2bvMzLD9+bqCDarbw==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="258f100cf06bd0151d52bc4bb872539cda9eef65" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="VYHambN7HAYCIR8wWQ5bWRuc+mVLrjbDZSi1tLTGrzUw1OnwwR5Drov+01GVH+QYtrDin0SXVypSOFc8A9UiPQ==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
  <a href="https://help.github.com/articles/which-remote-url-should-i-use" class="help tooltipped tooltipped-n" aria-label="Get help on which URL is right for you.">
    <span class="octicon octicon-question"></span>
  </a>
</div>
  <a href="https://windows.github.com" class="btn btn-sm sidebar-button" title="Save ondras/rot.js to your computer and use it in GitHub Desktop." aria-label="Save ondras/rot.js to your computer and use it in GitHub Desktop.">
...
<div class="file">
  ...
  <div class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC13" class="blob-code blob-code-inner js-file-line"><span class="pl-s"><span class="pl-pds">&quot;</span>undefined<span class="pl-pds">&quot;</span></span><span class="pl-k">!=</span><span class="pl-k">typeof</span> <span class="pl-c1">window</span><span class="pl-k">&amp;&amp;</span>(<span class="pl-c1">window</span>.requestAnimationFrame<span class="pl-k">=</span><span class="pl-c1">window</span>.requestAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.mozRequestAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.webkitRequestAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.oRequestAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.msRequestAnimationFrame<span class="pl-k">||</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">return</span> <span class="pl-c1">setTimeout</span>(a,<span class="pl-c1">1E3</span><span class="pl-k">/</span><span class="pl-c1">60</span>)},<span class="pl-c1">window</span>.cancelAnimationFrame<span class="pl-k">=</span><span class="pl-c1">window</span>.cancelAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.mozCancelAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.webkitCancelAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.oCancelAnimationFrame<span class="pl-k">||</span><span class="pl-c1">window</span>.msCancelAnimationFrame<span class="pl-k">||</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">return</span> <span class="pl-c1">clearTimeout</span>(a)});</td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT</span>.<span class="pl-en">Display</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-v">this</span>._context<span class="pl-k">=</span><span class="pl-c1">document</span>.<span class="pl-c1">createElement</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>canvas<span class="pl-pds">&quot;</span></span>).getContext(<span class="pl-s"><span class="pl-pds">&quot;</span>2d<span class="pl-pds">&quot;</span></span>);<span class="pl-v">this</span>._data<span class="pl-k">=</span>{};<span class="pl-v">this</span>._dirty<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>;<span class="pl-v">this</span>._options<span class="pl-k">=</span>{};<span class="pl-v">this</span>._backend<span class="pl-k">=</span><span class="pl-c1">null</span>;<span class="pl-k">var</span> b<span class="pl-k">=</span>{width<span class="pl-k">:</span><span class="pl-c1">ROT</span>.DEFAULT_WIDTH,height<span class="pl-k">:</span><span class="pl-c1">ROT</span>.DEFAULT_HEIGHT,transpose<span class="pl-k">:</span><span class="pl-k">!</span><span class="pl-c1">1</span>,layout<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span>rect<span class="pl-pds">&quot;</span></span>,fontSize<span class="pl-k">:</span><span class="pl-c1">15</span>,spacing<span class="pl-k">:</span><span class="pl-c1">1</span>,border<span class="pl-k">:</span><span class="pl-c1">0</span>,forceSquareRatio<span class="pl-k">:</span><span class="pl-k">!</span><span class="pl-c1">1</span>,fontFamily<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span>monospace<span class="pl-pds">&quot;</span></span>,fontStyle<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-pds">&quot;</span></span>,fg<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span>#ccc<span class="pl-pds">&quot;</span></span>,bg<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span>#000<span class="pl-pds">&quot;</span></span>,tileWidth<span class="pl-k">:</span><span class="pl-c1">32</span>,tileHeight<span class="pl-k">:</span><span class="pl-c1">32</span>,tileMap<span class="pl-k">:</span>{},tileSet<span class="pl-k">:</span><span class="pl-c1">null</span>,tileColorize<span class="pl-k">:</span><span class="pl-k">!</span><span class="pl-c1">1</span>,termColor<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span>xterm<span class="pl-pds">&quot;</span></span>},c;<span class="pl-k">for</span>(c <span class="pl-k">in</span> a)b[c]<span class="pl-k">=</span>a[c];<span class="pl-v">this</span>.setOptions(b);<span class="pl-v">this</span>.DEBUG<span class="pl-k">=</span><span class="pl-v">this</span>.DEBUG.bind(<span class="pl-v">this</span>);</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line"><span class="pl-v">this</span>._tick<span class="pl-k">=</span><span class="pl-v">this</span>._tick.bind(<span class="pl-v">this</span>);requestAnimationFrame(<span class="pl-v">this</span>._tick)};<span class="pl-c1">ROT.Display</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">DEBUG</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>){<span class="pl-k">var</span> d<span class="pl-k">=</span>[<span class="pl-v">this</span>._options.bg,<span class="pl-v">this</span>._options.fg];<span class="pl-v">this</span>.draw(a,b,<span class="pl-c1">null</span>,<span class="pl-c1">null</span>,d[c<span class="pl-k">%</span>d.<span class="pl-c1">length</span>])};<span class="pl-c1">ROT.Display</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">clear</span><span class="pl-k">=</span><span class="pl-k">function</span>(){<span class="pl-v">this</span>._data<span class="pl-k">=</span>{};<span class="pl-v">this</span>._dirty<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>};</td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Display</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">setOptions</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">for</span>(<span class="pl-k">var</span> b <span class="pl-k">in</span> a)<span class="pl-v">this</span>._options[b]<span class="pl-k">=</span>a[b];<span class="pl-k">if</span>(a.<span class="pl-c1">width</span><span class="pl-k">||</span>a.<span class="pl-c1">height</span><span class="pl-k">||</span>a.<span class="pl-c1">fontSize</span><span class="pl-k">||</span>a.<span class="pl-c1">fontFamily</span><span class="pl-k">||</span>a.spacing<span class="pl-k">||</span>a.layout)a.layout<span class="pl-k">&amp;&amp;</span>(<span class="pl-v">this</span>._backend<span class="pl-k">=</span><span class="pl-k">new</span> (<span class="pl-c1">ROT</span>.Display[a.layout.capitalize()])(<span class="pl-v">this</span>._context)),a<span class="pl-k">=</span>(<span class="pl-v">this</span>._options.fontStyle<span class="pl-k">?</span><span class="pl-v">this</span>._options.fontStyle<span class="pl-k">+</span><span class="pl-s"><span class="pl-pds">&quot;</span> <span class="pl-pds">&quot;</span></span><span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-pds">&quot;</span></span>)<span class="pl-k">+</span><span class="pl-v">this</span>._options.<span class="pl-c1">fontSize</span><span class="pl-k">+</span><span class="pl-s"><span class="pl-pds">&quot;</span>px <span class="pl-pds">&quot;</span></span><span class="pl-k">+</span><span class="pl-v">this</span>._options.<span class="pl-c1">fontFamily</span>,<span class="pl-v">this</span>._context.font<span class="pl-k">=</span>a,<span class="pl-v">this</span>._backend.compute(<span class="pl-v">this</span>._options),<span class="pl-v">this</span>._context.font<span class="pl-k">=</span>a,<span class="pl-v">this</span>._context.<span class="pl-c1">textAlign</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&quot;</span>center<span class="pl-pds">&quot;</span></span>,<span class="pl-v">this</span>._context.textBaseline<span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&quot;</span>middle<span class="pl-pds">&quot;</span></span>,<span class="pl-v">this</span>._dirty<span class="pl-k">=</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC61" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.IceyMaze</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">create</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">var</span> b<span class="pl-k">=</span><span class="pl-v">this</span>._width,c<span class="pl-k">=</span><span class="pl-v">this</span>._height,d<span class="pl-k">=</span><span class="pl-v">this</span>._fillMap(<span class="pl-c1">1</span>),b<span class="pl-k">=</span>b<span class="pl-k">-</span>(b<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">?</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">2</span>),c<span class="pl-k">=</span>c<span class="pl-k">-</span>(c<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">?</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">2</span>),e<span class="pl-k">=</span><span class="pl-c1">0</span>,f<span class="pl-k">=</span><span class="pl-c1">0</span>,g<span class="pl-k">=</span><span class="pl-c1">0</span>,h<span class="pl-k">=</span><span class="pl-c1">0</span>,l<span class="pl-k">=</span><span class="pl-c1">0</span>,m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>,p<span class="pl-k">=</span>[[<span class="pl-c1">0</span>,<span class="pl-c1">0</span>],[<span class="pl-c1">0</span>,<span class="pl-c1">0</span>],[<span class="pl-c1">0</span>,<span class="pl-c1">0</span>],[<span class="pl-c1">0</span>,<span class="pl-c1">0</span>]];<span class="pl-k">do</span> <span class="pl-k">if</span>(e<span class="pl-k">=</span><span class="pl-c1">1</span><span class="pl-k">+</span><span class="pl-c1">2</span><span class="pl-k">*</span><span class="pl-c1">Math</span>.<span class="pl-c1">floor</span>(<span class="pl-c1">ROT</span>.RNG.getUniform()<span class="pl-k">*</span>(b<span class="pl-k">-</span><span class="pl-c1">1</span>)<span class="pl-k">/</span><span class="pl-c1">2</span>),f<span class="pl-k">=</span><span class="pl-c1">1</span><span class="pl-k">+</span><span class="pl-c1">2</span><span class="pl-k">*</span><span class="pl-c1">Math</span>.<span class="pl-c1">floor</span>(<span class="pl-c1">ROT</span>.RNG.getUniform()<span class="pl-k">*</span>(c<span class="pl-k">-</span><span class="pl-c1">1</span>)<span class="pl-k">/</span><span class="pl-c1">2</span>),l<span class="pl-k">||</span>(d[e][f]<span class="pl-k">=</span><span class="pl-c1">0</span>),<span class="pl-k">!</span>d[e][f]){<span class="pl-v">this</span>._randomize(p);<span class="pl-k">do</span>{<span class="pl-c1">0</span><span class="pl-k">==</span><span class="pl-c1">Math</span>.<span class="pl-c1">floor</span>(<span class="pl-c1">ROT</span>.RNG.getUniform()<span class="pl-k">*</span>(<span class="pl-v">this</span>._regularity<span class="pl-k">+</span><span class="pl-c1">1</span>))<span class="pl-k">&amp;&amp;</span><span class="pl-v">this</span>._randomize(p);<span class="pl-k">for</span>(<span class="pl-k">var</span> m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>,q<span class="pl-k">=</span><span class="pl-c1">0</span>;<span class="pl-c1">4</span><span class="pl-k">&gt;</span>q;q<span class="pl-k">++</span>)<span class="pl-k">if</span>(g<span class="pl-k">=</span>e<span class="pl-k">+</span><span class="pl-c1">2</span><span class="pl-k">*</span>p[q][<span class="pl-c1">0</span>],h<span class="pl-k">=</span>f<span class="pl-k">+</span><span class="pl-c1">2</span><span class="pl-k">*</span>p[q][<span class="pl-c1">1</span>],<span class="pl-v">this</span>._isFree(d,g,h,b,c)){d[g][h]<span class="pl-k">=</span><span class="pl-c1">0</span>;d[e<span class="pl-k">+</span>p[q][<span class="pl-c1">0</span>]][f<span class="pl-k">+</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC68" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Cellular</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">create</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">for</span>(<span class="pl-k">var</span> b<span class="pl-k">=</span><span class="pl-v">this</span>._fillMap(<span class="pl-c1">0</span>),c<span class="pl-k">=</span><span class="pl-v">this</span>._options.born,d<span class="pl-k">=</span><span class="pl-v">this</span>._options.survive,e<span class="pl-k">=</span><span class="pl-c1">0</span>;e<span class="pl-k">&lt;</span><span class="pl-v">this</span>._height;e<span class="pl-k">++</span>){<span class="pl-k">var</span> f<span class="pl-k">=</span><span class="pl-c1">1</span>,g<span class="pl-k">=</span><span class="pl-c1">0</span>;<span class="pl-c1">6</span><span class="pl-k">==</span><span class="pl-v">this</span>._options.topology<span class="pl-k">&amp;&amp;</span>(f<span class="pl-k">=</span><span class="pl-c1">2</span>,g<span class="pl-k">=</span>e<span class="pl-k">%</span><span class="pl-c1">2</span>);<span class="pl-k">for</span>(;g<span class="pl-k">&lt;</span><span class="pl-v">this</span>._width;g<span class="pl-k">+=</span>f){<span class="pl-k">var</span> h<span class="pl-k">=</span><span class="pl-v">this</span>._map[g][e],l<span class="pl-k">=</span><span class="pl-v">this</span>._getNeighbors(g,e);h<span class="pl-k">&amp;&amp;</span><span class="pl-k">-</span><span class="pl-c1">1</span><span class="pl-k">!=</span>d.<span class="pl-c1">indexOf</span>(l)<span class="pl-k">?</span>b[g][e]<span class="pl-k">=</span><span class="pl-c1">1</span><span class="pl-k">:</span>h<span class="pl-k">||</span><span class="pl-k">-</span><span class="pl-c1">1</span><span class="pl-k">==</span>c.<span class="pl-c1">indexOf</span>(l)<span class="pl-k">||</span>(b[g][e]<span class="pl-k">=</span><span class="pl-c1">1</span>)}}<span class="pl-v">this</span>._map<span class="pl-k">=</span>b;<span class="pl-v">this</span>._options.connected<span class="pl-k">&amp;&amp;</span><span class="pl-v">this</span>._completeMaze();<span class="pl-k">if</span>(a)<span class="pl-k">for</span>(e<span class="pl-k">=</span><span class="pl-c1">0</span>;e<span class="pl-k">&lt;</span><span class="pl-v">this</span>._height;e<span class="pl-k">++</span>)<span class="pl-k">for</span>(f<span class="pl-k">=</span><span class="pl-c1">1</span>,g<span class="pl-k">=</span><span class="pl-c1">0</span>,<span class="pl-c1">6</span><span class="pl-k">==</span><span class="pl-v">this</span>._options.topology<span class="pl-k">&amp;&amp;</span>(f<span class="pl-k">=</span><span class="pl-c1">2</span>,g<span class="pl-k">=</span>e<span class="pl-k">%</span><span class="pl-c1">2</span>);g<span class="pl-k">&lt;</span><span class="pl-v">this</span>._width;g<span class="pl-k">+=</span>f)a(g,e,b[g][e])};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC72" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Cellular</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_getClosest</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-k">var</span> c<span class="pl-k">=</span><span class="pl-c1">null</span>,d<span class="pl-k">=</span><span class="pl-c1">null</span>;<span class="pl-k">for</span>(k <span class="pl-k">in</span> b){<span class="pl-k">var</span> e<span class="pl-k">=</span>b[k],f<span class="pl-k">=</span>(e[<span class="pl-c1">0</span>]<span class="pl-k">-</span>a[<span class="pl-c1">0</span>])<span class="pl-k">*</span>(e[<span class="pl-c1">0</span>]<span class="pl-k">-</span>a[<span class="pl-c1">0</span>])<span class="pl-k">+</span>(e[<span class="pl-c1">1</span>]<span class="pl-k">-</span>a[<span class="pl-c1">1</span>])<span class="pl-k">*</span>(e[<span class="pl-c1">1</span>]<span class="pl-k">-</span>a[<span class="pl-c1">1</span>]);<span class="pl-k">if</span>(<span class="pl-c1">null</span><span class="pl-k">==</span>d<span class="pl-k">||</span>f<span class="pl-k">&lt;</span>d)d<span class="pl-k">=</span>f,c<span class="pl-k">=</span>e}<span class="pl-k">return</span> c};<span class="pl-c1">ROT.Map.Cellular</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_findConnected</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>,<span class="pl-smi">d</span>){<span class="pl-k">for</span>(;<span class="pl-c1">0</span><span class="pl-k">&lt;</span>c.<span class="pl-c1">length</span>;)<span class="pl-k">for</span>(<span class="pl-k">var</span> e<span class="pl-k">=</span>c.<span class="pl-c1">splice</span>(<span class="pl-c1">0</span>,<span class="pl-c1">1</span>)[<span class="pl-c1">0</span>],e<span class="pl-k">=</span>[[e[<span class="pl-c1">0</span>]<span class="pl-k">+</span><span class="pl-c1">1</span>,e[<span class="pl-c1">1</span>]],[e[<span class="pl-c1">0</span>]<span class="pl-k">-</span><span class="pl-c1">1</span>,e[<span class="pl-c1">1</span>]],[e[<span class="pl-c1">0</span>],e[<span class="pl-c1">1</span>]<span class="pl-k">+</span><span class="pl-c1">1</span>],[e[<span class="pl-c1">0</span>],e[<span class="pl-c1">1</span>]<span class="pl-k">-</span><span class="pl-c1">1</span>]],f<span class="pl-k">=</span><span class="pl-c1">0</span>;f<span class="pl-k">&lt;</span>e.<span class="pl-c1">length</span>;f<span class="pl-k">++</span>){<span class="pl-k">var</span> g<span class="pl-k">=</span><span class="pl-v">this</span>._pointKey(e[f]);<span class="pl-c1">null</span><span class="pl-k">==</span>a[g]<span class="pl-k">&amp;&amp;</span><span class="pl-v">this</span>._freeSpace(e[f][<span class="pl-c1">0</span>],e[f][<span class="pl-c1">1</span>])<span class="pl-k">&amp;&amp;</span>(a[g]<span class="pl-k">=</span>e[f],d<span class="pl-k">||</span><span class="pl-k">delete</span> b[g],c.<span class="pl-c1">push</span>(e[f]))}};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC78" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Digger</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_isWallCallback</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-k">return</span> <span class="pl-c1">0</span><span class="pl-k">&gt;</span>a<span class="pl-k">||</span><span class="pl-c1">0</span><span class="pl-k">&gt;</span>b<span class="pl-k">||</span>a<span class="pl-k">&gt;=</span><span class="pl-v">this</span>._width<span class="pl-k">||</span>b<span class="pl-k">&gt;=</span><span class="pl-v">this</span>._height<span class="pl-k">?</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">1</span><span class="pl-k">==</span><span class="pl-v">this</span>._map[a][b]};<span class="pl-c1">ROT.Map.Digger</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_canBeDugCallback</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-k">return</span> <span class="pl-c1">1</span><span class="pl-k">&gt;</span>a<span class="pl-k">||</span><span class="pl-c1">1</span><span class="pl-k">&gt;</span>b<span class="pl-k">||</span>a<span class="pl-k">+</span><span class="pl-c1">1</span><span class="pl-k">&gt;=</span><span class="pl-v">this</span>._width<span class="pl-k">||</span>b<span class="pl-k">+</span><span class="pl-c1">1</span><span class="pl-k">&gt;=</span><span class="pl-v">this</span>._height<span class="pl-k">?</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">1</span><span class="pl-k">==</span><span class="pl-v">this</span>._map[a][b]};<span class="pl-c1">ROT.Map.Digger</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_priorityWallCallback</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-v">this</span>._walls[a<span class="pl-k">+</span><span class="pl-s"><span class="pl-pds">&quot;</span>,<span class="pl-pds">&quot;</span></span><span class="pl-k">+</span>b]<span class="pl-k">=</span><span class="pl-c1">2</span>};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC93" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Uniform</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_isWallCallback</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-k">return</span> <span class="pl-c1">0</span><span class="pl-k">&gt;</span>a<span class="pl-k">||</span><span class="pl-c1">0</span><span class="pl-k">&gt;</span>b<span class="pl-k">||</span>a<span class="pl-k">&gt;=</span><span class="pl-v">this</span>._width<span class="pl-k">||</span>b<span class="pl-k">&gt;=</span><span class="pl-v">this</span>._height<span class="pl-k">?</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">1</span><span class="pl-k">==</span><span class="pl-v">this</span>._map[a][b]};<span class="pl-c1">ROT.Map.Uniform</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_canBeDugCallback</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-k">return</span> <span class="pl-c1">1</span><span class="pl-k">&gt;</span>a<span class="pl-k">||</span><span class="pl-c1">1</span><span class="pl-k">&gt;</span>b<span class="pl-k">||</span>a<span class="pl-k">+</span><span class="pl-c1">1</span><span class="pl-k">&gt;=</span><span class="pl-v">this</span>._width<span class="pl-k">||</span>b<span class="pl-k">+</span><span class="pl-c1">1</span><span class="pl-k">&gt;=</span><span class="pl-v">this</span>._height<span class="pl-k">?</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">1</span><span class="pl-k">==</span><span class="pl-v">this</span>._map[a][b]};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC102" class="blob-code blob-code-inner js-file-line">n<span class="pl-k">=</span><span class="pl-c1">Math</span>.<span class="pl-c1">round</span>(<span class="pl-c1">ROT</span>.RNG.getUniformInt(<span class="pl-c1">0</span>,e<span class="pl-k">-</span>g)<span class="pl-k">/</span><span class="pl-c1">2</span>);<span class="pl-k">for</span>(<span class="pl-k">var</span> u<span class="pl-k">=</span><span class="pl-c1">Math</span>.<span class="pl-c1">round</span>(<span class="pl-c1">ROT</span>.RNG.getUniformInt(<span class="pl-c1">0</span>,f<span class="pl-k">-</span>h)<span class="pl-k">/</span><span class="pl-c1">2</span>);p<span class="pl-k">+</span>n<span class="pl-k">+</span>g<span class="pl-k">&gt;=</span>a;)n<span class="pl-k">?</span>n<span class="pl-k">--</span><span class="pl-k">:</span>g<span class="pl-k">--</span>;<span class="pl-k">for</span>(;q<span class="pl-k">+</span>u<span class="pl-k">+</span>h<span class="pl-k">&gt;=</span>b;)u<span class="pl-k">?</span>u<span class="pl-k">--</span><span class="pl-k">:</span>h<span class="pl-k">--</span>;p<span class="pl-k">+=</span>n;q<span class="pl-k">+=</span>u;<span class="pl-v">this</span>.rooms[r][t].<span class="pl-c1">x</span><span class="pl-k">=</span>p;<span class="pl-v">this</span>.rooms[r][t].<span class="pl-c1">y</span><span class="pl-k">=</span>q;<span class="pl-v">this</span>.rooms[r][t].<span class="pl-c1">width</span><span class="pl-k">=</span>g;<span class="pl-v">this</span>.rooms[r][t].<span class="pl-c1">height</span><span class="pl-k">=</span>h;<span class="pl-k">for</span>(n<span class="pl-k">=</span>p;n<span class="pl-k">&lt;</span>p<span class="pl-k">+</span>g;n<span class="pl-k">++</span>)<span class="pl-k">for</span>(u<span class="pl-k">=</span>q;u<span class="pl-k">&lt;</span>q<span class="pl-k">+</span>h;u<span class="pl-k">++</span>)<span class="pl-v">this</span>.map[n][u]<span class="pl-k">=</span><span class="pl-c1">0</span>}};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC113" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Feature.Room</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">getTop</span><span class="pl-k">=</span><span class="pl-k">function</span>(){<span class="pl-k">return</span> <span class="pl-v">this</span>._y1};<span class="pl-c1">ROT.Map.Feature.Room</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">getBottom</span><span class="pl-k">=</span><span class="pl-k">function</span>(){<span class="pl-k">return</span> <span class="pl-v">this</span>._y2};<span class="pl-c1">ROT.Map.Feature</span>.<span class="pl-en">Corridor</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>,<span class="pl-smi">d</span>){<span class="pl-v">this</span>._startX<span class="pl-k">=</span>a;<span class="pl-v">this</span>._startY<span class="pl-k">=</span>b;<span class="pl-v">this</span>._endX<span class="pl-k">=</span>c;<span class="pl-v">this</span>._endY<span class="pl-k">=</span>d;<span class="pl-v">this</span>._endsWithAWall<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>};<span class="pl-c1">ROT</span>.Map.Feature.Corridor.extend(<span class="pl-c1">ROT</span>.Map.Feature);<span class="pl-c1">ROT.Map.Feature.Corridor</span>.<span class="pl-en">createRandomAt</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>,<span class="pl-smi">d</span>,<span class="pl-smi">e</span>){e<span class="pl-k">=</span><span class="pl-c1">ROT</span>.RNG.getUniformInt(e.corridorLength[<span class="pl-c1">0</span>],e.corridorLength[<span class="pl-c1">1</span>]);<span class="pl-k">return</span> <span class="pl-k">new</span> <span class="pl-en">this</span>(a,b,a<span class="pl-k">+</span>c<span class="pl-k">*</span>e,b<span class="pl-k">+</span>d<span class="pl-k">*</span>e)};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC115" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Feature.Corridor</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">isValid</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-k">var</span> c<span class="pl-k">=</span><span class="pl-v">this</span>._startX,d<span class="pl-k">=</span><span class="pl-v">this</span>._startY,e<span class="pl-k">=</span><span class="pl-v">this</span>._endX<span class="pl-k">-</span>c,f<span class="pl-k">=</span><span class="pl-v">this</span>._endY<span class="pl-k">-</span>d,g<span class="pl-k">=</span><span class="pl-c1">1</span><span class="pl-k">+</span><span class="pl-c1">Math</span>.<span class="pl-c1">max</span>(<span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(e),<span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(f));e<span class="pl-k">&amp;&amp;</span>(e<span class="pl-k">/=</span><span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(e));f<span class="pl-k">&amp;&amp;</span>(f<span class="pl-k">/=</span><span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(f));<span class="pl-k">for</span>(<span class="pl-k">var</span> h<span class="pl-k">=</span>f,l<span class="pl-k">=</span><span class="pl-k">-</span>e,m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>,p<span class="pl-k">=</span><span class="pl-c1">0</span>;p<span class="pl-k">&lt;</span>g;p<span class="pl-k">++</span>){<span class="pl-k">var</span> q<span class="pl-k">=</span>c<span class="pl-k">+</span>p<span class="pl-k">*</span>e,n<span class="pl-k">=</span>d<span class="pl-k">+</span>p<span class="pl-k">*</span>f;b(q,n)<span class="pl-k">||</span>(m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>);a(q<span class="pl-k">+</span>h,n<span class="pl-k">+</span>l)<span class="pl-k">||</span>(m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>);a(q<span class="pl-k">-</span>h,n<span class="pl-k">-</span>l)<span class="pl-k">||</span>(m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>);<span class="pl-k">if</span>(<span class="pl-k">!</span>m){g<span class="pl-k">=</span>p;<span class="pl-v">this</span>._endX<span class="pl-k">=</span>q<span class="pl-k">-</span>e;<span class="pl-v">this</span>._endY<span class="pl-k">=</span>n<span class="pl-k">-</span>f;<span class="pl-k">break</span>}}<span class="pl-k">if</span>(<span class="pl-c1">0</span><span class="pl-k">==</span>g<span class="pl-k">||</span><span class="pl-c1">1</span><span class="pl-k">==</span>g<span class="pl-k">&amp;&amp;</span>a(<span class="pl-v">this</span>._endX<span class="pl-k">+</span>e,<span class="pl-v">this</span>._endY<span class="pl-k">+</span>f))<span class="pl-k">return</span><span class="pl-k">!</span><span class="pl-c1">1</span>;c<span class="pl-k">=</span><span class="pl-k">!</span>a(<span class="pl-v">this</span>._endX<span class="pl-k">+</span>e<span class="pl-k">+</span>h,<span class="pl-v">this</span>._endY<span class="pl-k">+</span>f<span class="pl-k">+</span>l);h<span class="pl-k">=</span><span class="pl-k">!</span>a(<span class="pl-v">this</span>._endX<span class="pl-k">+</span>e<span class="pl-k">-</span>h,<span class="pl-v">this</span>._endY<span class="pl-k">+</span>f<span class="pl-k">-</span>l);<span class="pl-v">this</span>._endsWithAWall<span class="pl-k">=</span>a(<span class="pl-v">this</span>._endX<span class="pl-k">+</span></td>
      </tr>
      <tr>
        <td id="L116" class="blob-num js-line-number" data-line-number="116"></td>
        <td id="LC116" class="blob-code blob-code-inner js-file-line">e,<span class="pl-v">this</span>._endY<span class="pl-k">+</span>f);<span class="pl-k">return</span>(c<span class="pl-k">||</span>h)<span class="pl-k">&amp;&amp;</span><span class="pl-v">this</span>._endsWithAWall<span class="pl-k">?</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-k">!</span><span class="pl-c1">0</span>};<span class="pl-c1">ROT.Map.Feature.Corridor</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">create</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">var</span> b<span class="pl-k">=</span><span class="pl-v">this</span>._startX,c<span class="pl-k">=</span><span class="pl-v">this</span>._startY,d<span class="pl-k">=</span><span class="pl-v">this</span>._endX<span class="pl-k">-</span>b,e<span class="pl-k">=</span><span class="pl-v">this</span>._endY<span class="pl-k">-</span>c,f<span class="pl-k">=</span><span class="pl-c1">1</span><span class="pl-k">+</span><span class="pl-c1">Math</span>.<span class="pl-c1">max</span>(<span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(d),<span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(e));d<span class="pl-k">&amp;&amp;</span>(d<span class="pl-k">/=</span><span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(d));e<span class="pl-k">&amp;&amp;</span>(e<span class="pl-k">/=</span><span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(e));<span class="pl-k">for</span>(<span class="pl-k">var</span> g<span class="pl-k">=</span><span class="pl-c1">0</span>;g<span class="pl-k">&lt;</span>f;g<span class="pl-k">++</span>)a(b<span class="pl-k">+</span>g<span class="pl-k">*</span>d,c<span class="pl-k">+</span>g<span class="pl-k">*</span>e,<span class="pl-c1">0</span>);<span class="pl-k">return</span><span class="pl-k">!</span><span class="pl-c1">0</span>};</td>
      </tr>
      <tr>
        <td id="L117" class="blob-num js-line-number" data-line-number="117"></td>
        <td id="LC117" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Map.Feature.Corridor</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">createPriorityWalls</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">if</span>(<span class="pl-v">this</span>._endsWithAWall){<span class="pl-k">var</span> b<span class="pl-k">=</span><span class="pl-v">this</span>._endX<span class="pl-k">-</span><span class="pl-v">this</span>._startX,c<span class="pl-k">=</span><span class="pl-v">this</span>._endY<span class="pl-k">-</span><span class="pl-v">this</span>._startY;b<span class="pl-k">&amp;&amp;</span>(b<span class="pl-k">/=</span><span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(b));c<span class="pl-k">&amp;&amp;</span>(c<span class="pl-k">/=</span><span class="pl-c1">Math</span>.<span class="pl-c1">abs</span>(c));<span class="pl-k">var</span> d<span class="pl-k">=</span>c,e<span class="pl-k">=</span><span class="pl-k">-</span>b;a(<span class="pl-v">this</span>._endX<span class="pl-k">+</span>b,<span class="pl-v">this</span>._endY<span class="pl-k">+</span>c);a(<span class="pl-v">this</span>._endX<span class="pl-k">+</span>d,<span class="pl-v">this</span>._endY<span class="pl-k">+</span>e);a(<span class="pl-v">this</span>._endX<span class="pl-k">-</span>d,<span class="pl-v">this</span>._endY<span class="pl-k">-</span>e)}};<span class="pl-c1">ROT</span>.<span class="pl-en">Noise</span><span class="pl-k">=</span><span class="pl-k">function</span>(){};<span class="pl-c1">ROT.Noise</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">get</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC122" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.FOV.DiscreteShadowcasting</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">compute</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>,<span class="pl-smi">d</span>){d(a,b,<span class="pl-c1">0</span>,<span class="pl-c1">1</span>);<span class="pl-k">if</span>(<span class="pl-v">this</span>._lightPasses(a,b))<span class="pl-k">for</span>(<span class="pl-k">var</span> e<span class="pl-k">=</span>[],f,g,h,l,m,p<span class="pl-k">=</span><span class="pl-c1">1</span>;p<span class="pl-k">&lt;=</span>c;p<span class="pl-k">++</span>)<span class="pl-k">for</span>(<span class="pl-k">var</span> q<span class="pl-k">=</span><span class="pl-v">this</span>._getCircle(a,b,p),n<span class="pl-k">=</span><span class="pl-c1">360</span><span class="pl-k">/</span>q.<span class="pl-c1">length</span>,r<span class="pl-k">=</span><span class="pl-c1">0</span>;r<span class="pl-k">&lt;</span>q.<span class="pl-c1">length</span>;r<span class="pl-k">++</span>)<span class="pl-k">if</span>(h<span class="pl-k">=</span>q[r][<span class="pl-c1">0</span>],l<span class="pl-k">=</span>q[r][<span class="pl-c1">1</span>],f<span class="pl-k">=</span>n<span class="pl-k">*</span>(r<span class="pl-k">-</span>.<span class="pl-c1">5</span>),g<span class="pl-k">=</span>f<span class="pl-k">+</span>n,m<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-v">this</span>._lightPasses(h,l),<span class="pl-v">this</span>._visibleCoords(<span class="pl-c1">Math</span>.<span class="pl-c1">floor</span>(f),<span class="pl-c1">Math</span>.<span class="pl-c1">ceil</span>(g),m,e)<span class="pl-k">&amp;&amp;</span>d(h,l,p,<span class="pl-c1">1</span>),<span class="pl-c1">2</span><span class="pl-k">==</span>e.<span class="pl-c1">length</span><span class="pl-k">&amp;&amp;</span><span class="pl-c1">0</span><span class="pl-k">==</span>e[<span class="pl-c1">0</span>]<span class="pl-k">&amp;&amp;</span><span class="pl-c1">360</span><span class="pl-k">==</span>e[<span class="pl-c1">1</span>])<span class="pl-k">return</span>};</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC124" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.FOV</span>.<span class="pl-en">PreciseShadowcasting</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){<span class="pl-c1">ROT</span>.FOV.<span class="pl-c1">call</span>(<span class="pl-v">this</span>,a,b)};<span class="pl-c1">ROT</span>.FOV.PreciseShadowcasting.extend(<span class="pl-c1">ROT</span>.FOV);<span class="pl-c1">ROT.FOV.PreciseShadowcasting</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">compute</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>,<span class="pl-smi">d</span>){d(a,b,<span class="pl-c1">0</span>,<span class="pl-c1">1</span>);<span class="pl-k">if</span>(<span class="pl-v">this</span>._lightPasses(a,b))<span class="pl-k">for</span>(<span class="pl-k">var</span> e<span class="pl-k">=</span>[],f,g,h,l,m,p<span class="pl-k">=</span><span class="pl-c1">1</span>;p<span class="pl-k">&lt;=</span>c;p<span class="pl-k">++</span>)<span class="pl-k">for</span>(<span class="pl-k">var</span> q<span class="pl-k">=</span><span class="pl-v">this</span>._getCircle(a,b,p),n<span class="pl-k">=</span>q.<span class="pl-c1">length</span>,r<span class="pl-k">=</span><span class="pl-c1">0</span>;r<span class="pl-k">&lt;</span>n;r<span class="pl-k">++</span>)<span class="pl-k">if</span>(f<span class="pl-k">=</span>q[r][<span class="pl-c1">0</span>],g<span class="pl-k">=</span>q[r][<span class="pl-c1">1</span>],l<span class="pl-k">=</span>[r<span class="pl-k">?</span><span class="pl-c1">2</span><span class="pl-k">*</span>r<span class="pl-k">-</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">2</span><span class="pl-k">*</span>n<span class="pl-k">-</span><span class="pl-c1">1</span>,<span class="pl-c1">2</span><span class="pl-k">*</span>n],m<span class="pl-k">=</span>[<span class="pl-c1">2</span><span class="pl-k">*</span>r<span class="pl-k">+</span><span class="pl-c1">1</span>,<span class="pl-c1">2</span><span class="pl-k">*</span>n],h<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-v">this</span>._lightPasses(f,g),(h<span class="pl-k">=</span><span class="pl-v">this</span>._checkVisibility(l,m,h,e))<span class="pl-k">&amp;&amp;</span>d(f,g,p,h),<span class="pl-c1">2</span><span class="pl-k">==</span>e.<span class="pl-c1">length</span><span class="pl-k">&amp;&amp;</span><span class="pl-c1">0</span><span class="pl-k">==</span>e[<span class="pl-c1">0</span>][<span class="pl-c1">0</span>]<span class="pl-k">&amp;&amp;</span>e[<span class="pl-c1">1</span>][<span class="pl-c1">0</span>]<span class="pl-k">==</span>e[<span class="pl-c1">1</span>][<span class="pl-c1">1</span>])<span class="pl-k">return</span>};</td>
      </tr>
      <tr>
        <td id="L125" class="blob-num js-line-number" data-line-number="125"></td>
        <td id="LC125" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.FOV.PreciseShadowcasting</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">_checkVisibility</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>,<span class="pl-smi">d</span>){<span class="pl-k">if</span>(a[<span class="pl-c1">0</span>]<span class="pl-k">&gt;</span>b[<span class="pl-c1">0</span>])<span class="pl-k">return</span> a<span class="pl-k">=</span><span class="pl-v">this</span>._checkVisibility(a,[a[<span class="pl-c1">1</span>],a[<span class="pl-c1">1</span>]],c,d),b<span class="pl-k">=</span><span class="pl-v">this</span>._checkVisibility([<span class="pl-c1">0</span>,<span class="pl-c1">1</span>],b,c,d),(a<span class="pl-k">+</span>b)<span class="pl-k">/</span><span class="pl-c1">2</span>;<span class="pl-k">for</span>(<span class="pl-k">var</span> e<span class="pl-k">=</span><span class="pl-c1">0</span>,f<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>;e<span class="pl-k">&lt;</span>d.<span class="pl-c1">length</span>;){<span class="pl-k">var</span> g<span class="pl-k">=</span>d[e],g<span class="pl-k">=</span>g[<span class="pl-c1">0</span>]<span class="pl-k">*</span>a[<span class="pl-c1">1</span>]<span class="pl-k">-</span>a[<span class="pl-c1">0</span>]<span class="pl-k">*</span>g[<span class="pl-c1">1</span>];<span class="pl-k">if</span>(<span class="pl-c1">0</span><span class="pl-k">&lt;=</span>g){<span class="pl-c1">0</span><span class="pl-k">!=</span>g<span class="pl-k">||</span>e<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">||</span>(f<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>);<span class="pl-k">break</span>}e<span class="pl-k">++</span>}<span class="pl-k">for</span>(<span class="pl-k">var</span> h<span class="pl-k">=</span>d.<span class="pl-c1">length</span>,l<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>;h<span class="pl-k">--</span>;)<span class="pl-k">if</span>(g<span class="pl-k">=</span>d[h],g<span class="pl-k">=</span>b[<span class="pl-c1">0</span>]<span class="pl-k">*</span>g[<span class="pl-c1">1</span>]<span class="pl-k">-</span>g[<span class="pl-c1">0</span>]<span class="pl-k">*</span>b[<span class="pl-c1">1</span>],<span class="pl-c1">0</span><span class="pl-k">&lt;=</span>g){<span class="pl-c1">0</span><span class="pl-k">==</span>g<span class="pl-k">&amp;&amp;</span>h<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">&amp;&amp;</span>(l<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>);<span class="pl-k">break</span>}g<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">0</span>;e<span class="pl-k">==</span>h<span class="pl-k">&amp;&amp;</span>(f<span class="pl-k">||</span>l)<span class="pl-k">?</span>g<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span>f<span class="pl-k">&amp;&amp;</span>l<span class="pl-k">&amp;&amp;</span>e<span class="pl-k">+</span><span class="pl-c1">1</span><span class="pl-k">==</span>h<span class="pl-k">&amp;&amp;</span>h<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">?</span>g<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span><span class="pl-k">:</span>e<span class="pl-k">&gt;</span>h<span class="pl-k">&amp;&amp;</span>e<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">&amp;&amp;</span>(g<span class="pl-k">=</span><span class="pl-k">!</span><span class="pl-c1">1</span>);<span class="pl-k">if</span>(<span class="pl-k">!</span>g)<span class="pl-k">return</span> <span class="pl-c1">0</span>;f<span class="pl-k">=</span>h<span class="pl-k">-</span>e<span class="pl-k">+</span><span class="pl-c1">1</span>;<span class="pl-k">if</span>(f<span class="pl-k">%</span><span class="pl-c1">2</span>)e<span class="pl-k">%</span><span class="pl-c1">2</span><span class="pl-k">?</span>(h<span class="pl-k">=</span>d[e],h<span class="pl-k">=</span>(b[<span class="pl-c1">0</span>]<span class="pl-k">*</span>h[<span class="pl-c1">1</span>]<span class="pl-k">-</span>h[<span class="pl-c1">0</span>]<span class="pl-k">*</span>b[<span class="pl-c1">1</span>])<span class="pl-k">/</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC143" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">ROT.Lighting</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">setLight</span><span class="pl-k">=</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>,<span class="pl-smi">c</span>){a<span class="pl-k">=</span>a<span class="pl-k">+</span><span class="pl-s"><span class="pl-pds">&quot;</span>,<span class="pl-pds">&quot;</span></span><span class="pl-k">+</span>b;c<span class="pl-k">?</span><span class="pl-v">this</span>._lights[a]<span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&quot;</span>string<span class="pl-pds">&quot;</span></span><span class="pl-k">==</span><span class="pl-k">typeof</span> c<span class="pl-k">?</span><span class="pl-c1">ROT</span>.Color.fromString(c)<span class="pl-k">:</span>c<span class="pl-k">:</span><span class="pl-k">delete</span> <span class="pl-v">this</span>._lights[a];<span class="pl-k">return</span> <span class="pl-v">this</span>};<span class="pl-c1">ROT.Lighting</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">clearLights</span><span class="pl-k">=</span><span class="pl-k">function</span>(){<span class="pl-v">this</span>._lights<span class="pl-k">=</span>{}};<span class="pl-c1">ROT.Lighting</span>.<span class="pl-c1">prototype</span>.<span class="pl-en">reset</span><span class="pl-k">=</span><span class="pl-k">function</span>(){<span class="pl-v">this</span>._reflectivityCache<span class="pl-k">=</span>{};<span class="pl-v">this</span>._fovCache<span class="pl-k">=</span>{};<span class="pl-k">return</span> <span class="pl-v">this</span>};</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05566s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
